module Mathbox.Class.View.Stereographic where
...
type Stereographic = StereographicG Field MaybeField

type JsStereographic =
...
stereographicToJs :: Stereographic -> JsStereographic
stereographicToJs s =
  { id                   : toNullable s.id
